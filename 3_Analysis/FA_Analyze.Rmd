...
# lets take a look at extinction in salt...without any stats tests. We will look at this in more depth in the longitudinal data (either as extinciton or fixation)
```{R}
...
# 
# 
# my <- myCOPRspread[,c("ext_0.0", "ext_p_0.0", "ext_0.4", "ext_p_0.4", "ext_0.8", "ext_p_0.8", "ext_1.2", "ext_p_1.2")]
# my <- myCOPRspread[,c("ext_0.0", "ext_0.4", "ext_0.8", "ext_1.2")]
# myres <- matrix(nrow = 7, ncol = 3); rownames(myres) <- rownames(my)
# colnames(myres) <- c("ext_n", "ext_se", "ext_p")
# myres[,1] <- apply(my, 1, mean)
# myres[,2] <- apply(my, 1, sjstats::se)
# myres[,3] <- myres[,1] / myCOPRspread[,"tot_0.0"]
```
...
I will write these tests here...but I am hesitant to copy the results down by hand again...Lets just get the code down in case we need it later.
