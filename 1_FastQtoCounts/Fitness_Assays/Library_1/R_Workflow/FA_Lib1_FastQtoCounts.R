...
dir_metadata <- "1_FastQtoCounts/Fitness_Assays/Library_1/Metadata"
dir_it_fastq <- "1_FastQtoCounts/Fitness_Assays/Library_1/IonTorrent_Files/IonTorrent_FastQ"
dir_it_df <- "1_FastQtoCounts/Fitness_Assays/Library_1/IonTorrent_Files/IonTorrent_DF"
dir_counts <-"1_FastQtoCounts/Fitness_Assays/Library_1/Counts"
# ------------------------------------------------------------------------------
