...
min(my$re_fit_e, na.rm = T)
min(my$re_fit_a, na.rm = T)
min(my$re_dw, na.rm = T)
...
my$reads_dw_00_80 <- rowMeans(my[,c("dw_00", "dw_80")], na.rm = T); my$reads_dw_00_80[is.nan(my$reads_dw_00_80)] <- NA
