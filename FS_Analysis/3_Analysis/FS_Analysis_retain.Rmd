...
ppp$treat <- "EH40_80"
qqq$treat <- "EH40"
tempdata <- rbind(aaa, zzz, nnn, ppp, qqq)
tempdata$cost <- tempdata$dist*tempdata$sign
tempdata$treat <- factor(tempdata$treat, levels = c("EH0_40", "EH40", "EH20_60", "EH0_80", "EH40_80"))
hist(tempdata$cost)
...
print("n with cost")
table(tempdata[tempdata$cost < -0.0217,]$treat)
print("p with cost")
table(tempdata[tempdata$cost < -0.0217,]$treat)/table(tempdata$treat)
print("n neutral")
table(tempdata[tempdata$cost > -0.0217 & tempdata$cost < 0.0217,]$treat)
print("p neutral")
table(tempdata[tempdata$cost > -0.0217 & tempdata$cost < 0.0217,]$treat)/table(tempdata$treat)
...
table(tempdata$treat)
print("n with cost")
table(tempdata[tempdata$cost < -0,]$treat)
print("p with cost")
table(tempdata[tempdata$cost < -0,]$treat)/table(tempdata$treat)
print("n with benefit")
table(tempdata[tempdata$cost > 0,]$treat)  
print("p with benefit")
table(tempdata[tempdata$cost > 0,]$treat)/table(tempdata$treat)
...
zppp$treat <- "EH40_80"
zqqq$treat <- "EH40"
tempdata <- rbind(zaaa, zzzz, znnn, zppp, zqqq)
tempdata$cost <- tempdata$dist*tempdata$sign
tempdata$treat <- factor(tempdata$treat, levels = c("EH0_40", "EH40", "EH20_60", "EH0_80", "EH40_80"))
hist(tempdata$cost)
mymod <- lm(cost ~ treat + 0, data = tempdata)
