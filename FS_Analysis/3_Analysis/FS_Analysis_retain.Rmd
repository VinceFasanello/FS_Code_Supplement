...
# # Save outputs to file ---------------------------------------------------------
# setwd(DIR_out); write.csv(mycc, file = "000_Table_Sn.csv")
...
p1 <- ggplot()+
  ...
  geom_point(aes(x = zb[1], y = zb[2]), color = "blue", size = 5, pch = 17)+
  geom_point(aes(x = zbb[1], y = zbb[2]), color = "blue", size = 5, pch = 17)+
  theme_VJF+xlab("Fitness Change: 0%")+ylab("Fitness Change: 40%") + labs(tag="A")
...
p1 <- p1 + annotate("text", x=0.012,y=0.35,label = "CuSO4", size = 3, fontface = "bold")
...
p2 <- ggplot()+
  ...
  geom_point(aes(x = za[1], y = za[2]), color = "purple", size = 5, pch = 17)+
  geom_point(aes(x = zaa[1], y = zaa[2]), color = "purple", size = 5, pch = 17)+
  theme_VJF+xlab("Fitness Change: 0%")+ylab("Fitness Change: 80%")+ labs(tag="B")
p2
...
p3 <- ggplot()+
  ...
  geom_point(aes(x = zc[1], y = zc[2]), color = "red", size = 5, pch = 17)+
  geom_point(aes(x = zcc[1], y = zcc[2]), color = "red", size = 5, pch = 17)+
  theme_VJF+xlab("Fitness Change: 40%")+ylab("Fitness Change: 80%")+ labs(tag="C")
p3
...
p3 <- ggplot(data = zaaa, aes(x = dw_00, y = dw_80))+
  ...
  geom_abline(slope = getline(b, c)[1], intercept = getline(b, c)[2], lty = "dotdash") +
  geom_point(pch = 1, color = mypalette[5], size = 0.75)+
  geom_point(data =zzzz, aes(x = dw_00, y = dw_80), color = mypalette[4], pch = 1, size = 0.75)+
  geom_point(data =znnn, aes(x = dw_00, y = dw_80), color = mypalette[2], pch = 1, size = 0.75)+
  geom_point(data =zppp, aes(x = dw_00, y = dw_80), color = mypalette[6], pch = 1, size = 0.75)+
  geom_point(data =zqqq, aes(x = dw_00, y = dw_80), color = mypalette[3], pch = 1, size = 0.75)+
  geom_point(x=a[1], y=a[2], fill = mypalette[5], size = 3, pch = 21)+
  geom_point(x=z[1], y=z[2], fill = mypalette[4], size = 3, pch = 21)+
  geom_point(x=n[1], y=n[2], fill = mypalette[2], size = 3, pch = 21)+
  geom_point(x=p[1], y=p[2], fill = mypalette[6], size = 3, pch = 21)+
  ...
  geom_point(x=c[1], y=c[2], color = "black", size = 2)+
  theme_VJF+xlab("Fitness Change: CM")+ylab("Fitness Change CM+80%")
p3 <- p3 + annotation_custom(legp, xmin = 0.075, ymin = 0.3)
...
zp1 <- ggplot(data = zmmm, aes(x = dw_00, y = dw_80))+
...
zp2 <- ggplot(data = znnn, aes(x = dw_00, y = dw_40))+
...
pdf("000_Figure_S3.pdf", width = 7, height =4)
...
pBB <- viopanel(dwdata=m2, statsdata=melt_myres_est_mn_COPR, fitlims=fitaxdatlimMN, insetlims=boxMN,
                fitaxlablim=fitaxlablimMN, treatlab=treatlabCOPR, fitlab=fitnesslab1, tag="B", dcol="dw_00_80")
pBB <- pBB  + 
