...
m %>% group_by(m$treat) %>%
  summarize(plus = sum(dvar_00_80 > 0)/length(dvar_00_80),
            minus = sum(dvar_00_80 < 0)/length(dvar_00_80),
...
m %>% group_by(m$treat) %>%
  summarize(plus = sum(dvar_00_40 > 0)/length(dvar_00_40),
...
m %>% group_by(m$treat) %>%
  summarize(plus = sum(dvar_40_80 > 0)/length(dvar_40_80),
...
m %>% group_by(m$treat) %>%
  summarize(plus = sum(dw_00_80 > 0.02)/length(dw_00_80),
...
m %>% group_by(m$treat) %>%
  summarize(plus = sum(dw_00_40 > 0.02)/length(dw_00_40),
...
m %>% group_by(m$treat) %>%
  summarize(plus = sum(dw_40_80 > 0.02)/length(dw_40_80),
...
mm %>% group_by(mm$treat) %>%
  summarize(sum = sum(signdiff)/length(signdiff),
            len = length(signdiff))
...
p1 <- ggplot(data = mmm, aes(x = dw_00, y = dw_80))+
  ...
  geom_point(pch = 1, color = "purple")+
  geom_point(x=a[1], y=a[2], color = "purple", size = 2)+
...
p2 <- ggplot(data = nnn, aes(x = dw_00, y = dw_40))+
  ...
  geom_point(x=a[1], y=a[2], color = "blue", size = 2)+
  geom_point(x=b[1], y=b[2], color = "black", size = 2)+
  geom_point(x=c[1], y=c[2], color = "black", size = 2)+
...
p4 <- ggplot()+
  geom_density(data = mmm, aes(x = dist*sign), color = "purple") + geom_rug(data=mmm, aes(x=dist*sign), color = rgb(1,0,1,0.5))+
  geom_density(data = nnn, aes(x = dist*sign), color = "blue") + geom_rug(data=nnn, aes(x=dist*sign), color = rgb(0,0,1,0.5))+
  geom_density(data = ppp, aes(x = dist*sign), color = "red") + geom_rug(data=ppp, (aes(x=dist*sign)), color = rgb(1,0,0,0.5))+ 
  geom_vline(aes(xintercept = 0), color = "gray", lty = "dotted")+
  geom_vline(aes(xintercept = mean(mmm$dist*mmm$sign)), lty = "dotted", color = "purple")+
  geom_vline(aes(xintercept = mean(nnn$dist*nnn$sign)), lty = "dotted", color = "blue")+
  geom_vline(aes(xintercept = mean(ppp$dist*ppp$sign)), lty = "dotted", color = "red")+
  xlim(-0.13,0.1)+
  theme_VJF

pdf("plot1noweights.pdf", width = 7, height =)
...
p1 <- ggplot(data = aaa, aes(x = dw_00, y = dw_80))+
  ...
  geom_abline(slope = getline(b, c)[1], intercept = getline(b, c)[2], lty = "dotted") +
  geom_point(pch = 1, color = "purple")+
  geom_point(data =zzz, aes(x = dw_00, y = dw_80), color = "hotpink", pch = 1)+
  geom_point(data =nnn, aes(x = dw_00, y = dw_80), color = "blue", pch = 1)+
  geom_point(data =ppp, aes(x = dw_00, y = dw_80), color = "red", pch = 1)+
  geom_point(data =qqq, aes(x = dw_00, y = dw_80), color = "gray", pch = 1)+
  geom_point(x=a[1], y=a[2], color = "purple", size = 2)+
  geom_point(x=z[1], y=z[2], color = "hotpink", size = 2)+
  geom_point(x=n[1], y=n[2], color = "blue", size = 2)+
  geom_point(x=p[1], y=p[2], color = "red", size = 2)+
  geom_point(x=q[1], y=q[2], color = "gray", size = 2)+
  geom_point(x=b[1], y=b[2], color = "black", size = 2)+
  geom_point(x=c[1], y=c[2], color = "black", size = 2)+
  theme_VJF+xlab("Fitness Change: CM")+ylab("Fitness Change CM+80%")
...
p2 <- ggplot()+
  geom_density(data = aaa, aes(x = dist*sign), color = "purple") + geom_rug(data=mmm, aes(x=dist*sign), color = rgb(1,0,1,0.5))+
  geom_density(data = zzz, aes(x = dist*sign), color = "hotpink") + geom_rug(data=zzz, aes(x=dist*sign), color = alpha("hotpink", 0.5))+
  geom_density(data = nnn, aes(x = dist*sign), color = "blue") + geom_rug(data=nnn, aes(x=dist*sign), color = rgb(0,0,1,0.5))+
  geom_density(data = ppp, aes(x = dist*sign), color = "red") + geom_rug(data=ppp, (aes(x=dist*sign)), color = rgb(1,0,0,0.5))+ 
  geom_density(data = qqq, aes(x = dist*sign), color = "gray") + geom_rug(data=qqq, (aes(x=dist*sign)), color =  alpha("gray", 0.5))+ 
  geom_vline(aes(xintercept = 0), color = "black", lty = "dotted")+
  geom_vline(aes(xintercept = mean(mmm$dist*mmm$sign)), lty = "dotted", color = "purple")+
  geom_vline(aes(xintercept = mean(zzz$dist*zzz$sign)), lty = "dotted", color = "hotpink")+
  geom_vline(aes(xintercept = mean(nnn$dist*nnn$sign)), lty = "dotted", color = "blue")+
  geom_vline(aes(xintercept = mean(ppp$dist*ppp$sign)), lty = "dotted", color = "red")+
  geom_vline(aes(xintercept = mean(qqq$dist*qqq$sign)), lty = "dotted", color = "gray")+
  xlim(-0.13,0.1)+
  theme_VJF

pdf("plot2noweights.pdf", width = 7, height =7)
...
pdf("plot1cnoweights.pdf", width = 7, height =)
grid.arrange(p1,p3,p2,p4, ncol = 2)
```
...
pdf("plot2cnoweights.pdf", width = 7, height =7)
grid.arrange(p1,p2, ncol = 1)
```
...
p1 <- ggplot()+
  ...
  geom_abline(slope = getline(a, aa)[1], intercept = getline(a, aa)[2], lty = "dotted", color = "purple") +
  geom_abline(slope = getline(b, bb)[1], intercept = getline(b, bb)[2], lty = "dotted", color = "blue") +
  geom_abline(slope = getline(c, cc)[1], intercept = getline(c, cc)[2], lty = "dotted", color = "red") +
  
  geom_abline(slope = getline(za, zaa)[1], intercept = getline(za, zaa)[2], lty = "dotted", color = "purple") +
  geom_abline(slope = getline(zb, zbb)[1], intercept = getline(zb, zbb)[2], lty = "dotted", color = "blue") +
  geom_abline(slope = getline(zc, zcc)[1], intercept = getline(zc, zcc)[2], lty = "dotted", color = "red") +
  
  geom_segment(aes(x=a[1], xend=aa[1], y=a[2], yend=aa[2]), color = "purple")+
  geom_segment(aes(x=b[1], xend=bb[1], y=b[2], yend=bb[2]), color = "blue")+
  geom_segment(aes(x=c[1], xend=cc[1], y=c[2], yend=cc[2]), color = "red")+

  geom_segment(aes(x=za[1], xend=zaa[1], y=za[2], yend=zaa[2]), color = "purple")+
  geom_segment(aes(x=zb[1], xend=zbb[1], y=zb[2], yend=zbb[2]), color = "blue")+
  geom_segment(aes(x=zc[1], xend=zcc[1], y=zc[2], yend=zcc[2]), color = "red")+
  
  geom_point(aes(x = a[1], y = a[2]), color = "purple", size = 2)+
  geom_point(aes(x = aa[1], y = aa[2]), color = "purple", size = 2)+
  geom_point(aes(x = b[1], y = b[2]), color = "blue", size = 2)+
  geom_point(aes(x = bb[1], y = bb[2]), color = "blue", size = 2)+
  geom_point(aes(x = c[1], y = c[2]), color = "red", size = 2)+
  geom_point(aes(x = cc[1], y = cc[2]), color = "red", size = 2)+
  
  geom_point(aes(x = za[1], y = za[2]), color = "purple", size = 2, pch = 1)+
  geom_point(aes(x = zaa[1], y = zaa[2]), color = "purple", size = 2, pch = 1)+
  geom_point(aes(x = zb[1], y = zb[2]), color = "blue", size = 2, pch = 1)+
  geom_point(aes(x = zbb[1], y = zbb[2]), color = "blue", size = 2, pch = 1)+
  geom_point(aes(x = zc[1], y = zc[2]), color = "red", size = 2, pch = 1)+
  geom_point(aes(x = zcc[1], y = zcc[2]), color = "red", size = 2, pch = 1)+
  theme_VJF+xlab("Fitness Change: lower")+ylab("Fitness Change: higher")

pdf("plot0noweights.pdf", width = 7, height = 7)
p1
dev.off()
```
