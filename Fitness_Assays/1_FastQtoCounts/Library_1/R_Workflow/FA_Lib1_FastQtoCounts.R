...
# Date: June 2021
# Project: Fluctuating selection project, Fitness Assays, Library 1 counts processing
...
# proceeding.
# -------------------------------------
dir_home <- # enter the path to your "FS_Code_Supplement/Fitness_Assays" directory here. 
dir_source <- "/1_FastQtoCounts/R_Source"
dir_metadata <- "/1_FastQtoCounts/Library_1/Metadata"
dir_it_fastq <- "/1_FastQtoCounts/Library_1/IonTorrent_Files/IonTorrent_FastQ"
dir_it_df <- "/1_FastQtoCounts/Library_1/IonTorrent_Files/IonTorrent_DF"
dir_counts <-"/1_FastQtoCounts/Library_1/Counts"
dir_counts2 <- "/2_CountstoAnalysis/Counts_Data/Library_1"
# ------------------------------------------------------------------------------
